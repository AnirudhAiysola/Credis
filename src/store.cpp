...
std::unordered_map<std::string, std::variant<std::string, Set, std::deque<std::string>, std::map<std::string, std::vector<std::pair<std::string, std::string>>, StreamComparator>>>
    kv_store;
